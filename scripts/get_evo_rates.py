...
def main(args):
    ...
    cases = pd.read_csv(os.path.join(input_dir, f"cases_group_data_{mode}_rates_nsp.csv"))
    controls = pd.read_csv(os.path.join(input_dir, f"controls_group_data_{mode}_rates_nsp.csv"))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', default='/sternadi/home/volume3/chronic-corona-pred/data/case_control/rates/', type=str,
